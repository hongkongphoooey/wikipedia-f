...
### Changelog:
* v1.0.1: synced from upstream, compileSdk bumped from 36 to 37
...
### Notes:
This project builds only the F-Droid variant using a debug signing key (app.apk) in Releases. Release version numbers do not match upstream.

### Pull Requests:
Unless it's security or new/different feature-related, don't bother - this project will be synced with upstream when the next public release version comes out.
